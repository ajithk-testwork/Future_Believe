    ...
    <section className="relative py-24 bg-white overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-24">
          ...
          >
            How Future Believe Transforms Audience Journeys
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
           At Future Believe App, we amplify your videos by showcasing them to a highly engaged community of knowledge aspirants. Our platform is designed to
            boost your visibility, expand your reach, and connect your content with right audience who truly value your product.
          </motion.p>
        </div>
