        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <h1 className="text-6xl md:text-[7rem] font-bold tracking-tighter leading-[0.9] text-slate-950 mb-10 hover:cursor-pointer">
              <span className="block reveal fade-in-up delay-100">Architecting</span>
            ...
            <div className="reveal fade-in-up delay-400 flex flex-wrap items-center gap-8">
              <button className="group relative px-10 py-5 bg-slate-950 text-white text-sm font-bold uppercase tracking-widest rounded-full overflow-hidden shadow-2xl shadow-purple-900/20 hover:shadow-purple-900/40 transition-all duration-500">
                <span className="relative z-10 group-hover:text-white transition-colors">Begin Your Journey</span>
          ...
          <div className="lg:col-span-5 relative reveal zoom-out delay-200 hover:cursor-pointer group perspective-1000">
            ...
            {/* Floating Card Overlay - Now Animated */}
            <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-3xl shadow-2xl max-w-[280px] hidden md:block border border-slate-50 animate-float">
              <div className="text-4xl font-serif italic text-purple-600 mb-2">
                100k+
              </div>
              ...
              <div className="flex -space-x-4">
                {[
                  ...
                  <img
                    ...
                    src={src}
                    alt="User"
                    className="w-10 h-10 rounded-full border-2 border-white object-cover transition-transform hover:scale-110 hover:z-10"
                  />
                ))}
     ...
     <section className="relative py-32 text-white rounded-t-[4rem] overflow-hidden mt-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Global Reach", icon: student, desc: "Connect with a thriving community of 100k+ students.", delay: "delay-100" },
              { title: "Rapid Scale", icon: timer, desc: "Engineered for short-term income and long-term equity.", delay: "delay-200" },
              { title: "Skill Equity", icon: money, desc: "Turn your innate talents into high-value digital currency.", delay: "delay-300" },
              { title: "Premium Suite", icon: product, desc: "Exclusive access to top-tier branding products.", delay: "delay-400" },
            ].map((item, idx) => (
              <div
                key={idx}
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="reveal fade-in-left order-2 lg:order-1 hover:cursor-pointer">
            <h2 className="text-5xl font-bold tracking-tight mb-8">
              Learning Without <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">Boundaries.</span>
            </h2>
            ...
            <div className="relative p-6 bg-white rounded-[3.5rem] shadow-2xl border border-slate-100 group">
              ...
              <div className="absolute top-1/2 -right-8 transform -translate-y-1/2 bg-white px-8 py-5 rounded-2xl shadow-[0_20px_50px_-10px_rgba(0,0,0,0.1)] border border-slate-50 hidden xl:flex items-center gap-4 animate-float delay-700">
                ...
                <div>
                    ...
                    <span className="text-sm font-bold text-slate-900">System Secure</span>
                </div>
              </div>
            </div>
          </div>
